...
import co.centauri.archetype.backend.service.exception.AuthenticationException;
import co.centauri.archetype.backend.service.exception.ForbiddenException;
import co.centauri.archetype.backend.service.exception.InternalServerError;
import co.centauri.archetype.backend.service.exception.InternalServerErrorFactory;
import co.centauri.archetype.backend.service.exception.NotFoundException;
import co.centauri.archetype.backend.service.exception.UnauthorizedException;
